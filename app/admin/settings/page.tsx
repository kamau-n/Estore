            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Enable Paystack payment processing</p>
                </div>
                <Switch
                  checked={paymentSettings.paystackEnabled}
                  onCheckedChange={(checked) => handleSwitchChange("payment", "paystackEnabled", checked)}
                />
              </div>
              ...
              {paymentSettings.paystackEnabled && (
                <div className="space-y-4 border-l-2 border-primary/20 pl-4">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">Your secret key is encrypted and stored securely</p>
                  </div>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="shipping">
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="standardShippingCost">Standard Shipping Cost (NGN)</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="expressShippingCost">Express Shipping Cost (NGN)</Label>
                  <Input
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange("shipping", "freeShippingEnabled", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange("shipping", "internationalShipping", checked)}
                  />
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="email">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure email notifications and marketing settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange("email", "orderConfirmationEnabled", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange("email", "shippingNotificationEnabled", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange("email", "marketingEmailsEnabled", checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange("email", "newsletterEnabled", checked)}
                  />
                </div>
              </div>
            </CardContent>
