...
import { Package, Users, ShoppingCart, DollarSign, Plus, Settings, BarChart3, TrendingUp } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats ? formatPrice(stats.totalRevenue) : "₦0"}</div>
              ...
              <div className="flex items-center justify-center py-12">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Go to the dedicated products page to manage your inventory</p>
                  </div>
                  <Button asChild>
              ...
              <div className="flex items-center justify-center py-12">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Go to the dedicated orders page to manage customer orders</p>
                  </div>
                  <Button asChild>
              ...
              <div className="flex items-center justify-center py-12">
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Go to the dedicated users page to manage customer accounts</p>
                  </div>
                  <Button asChild>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Configure payment methods, shipping, and other store settings
                    </p>
                  </div>
                  <Button asChild>
