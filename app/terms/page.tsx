    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          EStore, you agree to these terms.
        </p>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              By accessing and using EStore ("the Service"), you accept and
            ...
            <p className="text-sm text-muted-foreground">
              ...
              use the service, including customers, merchants, contributors, and
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground ml-4">
                ...
                <li>
                  • Subscribe to newsletters and promotional communications
                </li>
              </ul>
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                ...
                right to accept or decline any order for any reason. Order
                confirmation does not guarantee acceptance.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Payment is processed through Paystack, our secure payment partner.
            ...
            <p className="text-sm text-muted-foreground">
              We reserve the right to refuse or cancel orders if payment cannot
              be processed or if fraud is suspected.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Shipping terms and delivery timeframes are estimates only. We are
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Our return policy is detailed on our Returns page. Key points
              include:
            </p>
            <ul className="space-y-2 text-sm text-muted-foreground ml-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              ...
              are owned by EStore and are protected by international copyright,
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
              ...
              <p className="text-sm text-amber-700">
                To the maximum extent permitted by law, EStore shall not be
            ...
            <p className="text-sm text-muted-foreground">
              ...
              to this agreement shall not exceed the amount you paid to us in
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>
                <strong>Address:</strong> 123 Commerce Street, Victoria Island,
                Lagos, Nigeria
              </p>
            </div>
          </CardContent>
